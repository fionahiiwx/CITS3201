...
copy Public.DimAccount FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimAccount.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimCurrency';
copy Public.DimCurrency FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimCurrency.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimCustomer';
copy Public.DimCustomer FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimCustomer.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimDate';
copy Public.DimDate FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimDate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimDepartmentGroup';
copy Public.DimDepartmentGroup FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimDepartmentGroup.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimEmployee';
copy Public.DimEmployee FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimEmployee.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimGeography';
copy Public.DimGeography FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimGeography.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimOrganization';
copy Public.DimOrganization FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimOrganization.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProduct';
copy Public.DimProduct FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimProduct.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProductCategory';
copy Public.DimProductCategory FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimProductCategory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProductSubcategory';
copy Public.DimProductSubcategory FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimProductSubcategory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimPromotion';
copy Public.DimPromotion FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimPromotion.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimReseller';
copy Public.DimReseller FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimReseller.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimSalesReason';
copy Public.DimSalesReason FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimSalesReason.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimSalesTerritory';
copy Public.DimSalesTerritory FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimSalesTerritory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimScenario';
copy Public.DimScenario FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/DimScenario.csv' DELIMITER E'|' CSV;
...
copy Public.FactAdditionalInternationalProductDescription FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactAdditionalInternationalProductDescription.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactCallCenter';
copy Public.FactCallCenter FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactCallCenter.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactCurrencyRate';
copy Public.FactCurrencyRate FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactCurrencyRate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactFinance';
copy Public.FactFinance FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactFinance.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactInternetSales';
copy Public.FactInternetSales FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactInternetSales.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactInternetSalesReason';
copy Public.FactInternetSalesReason FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactInternetSalesReason.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactProductInventory';
copy Public.FactProductInventory FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactProductInventory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactResellerSales';
copy Public.FactResellerSales FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactResellerSales.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactSalesQuota';
copy Public.FactSalesQuota FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactSalesQuota.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactSurveyResponse';
copy Public.FactSurveyResponse FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/FactSurveyResponse.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.NewFactCurrencyRate';
copy Public.NewFactCurrencyRate FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/NewFactCurrencyRate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.ProspectiveBuyer';
copy Public.ProspectiveBuyer FROM 'C:/Fiona Documents/Uni/Yr 3 Sem 2/CITS3201/DW_2024-main/data/Data_for_local_PostgreSQL/AdventureWorkDW/ProspectiveBuyer.csv' DELIMITER E'|' CSV;
